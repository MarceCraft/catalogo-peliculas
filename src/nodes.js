...
const languageSelect=document.querySelector(".container-language");
const btnLanguage=document.querySelector(".select-btn");
const containerLanguage=document.querySelector(".select-language");